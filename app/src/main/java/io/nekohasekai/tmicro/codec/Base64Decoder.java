package io.nekohasekai.tmicro.codec;

import io.nekohasekai.tmicro.utils.ArrayUtil;
import io.nekohasekai.tmicro.utils.StrUtil;
...
public class Base64Decoder {
    ...
    public static byte[] decode(String str) {
        return decode(StrUtil.bytes(str));
    }
