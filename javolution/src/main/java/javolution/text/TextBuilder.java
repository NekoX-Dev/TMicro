...
public class TextBuilder implements Appendable,
    ...
    /**
     * Returns a {@link j2me.lang.CharSequence} corresponding
     ...
     */
    public final j2me.lang.CharSequence subSequence(int start, int end) {
     ...
     * @return <code>this</code>
     */
    public final Appendable/*TextBuilder*/ append(j2me.lang.CharSequence csq) {
     ...
     */
    public final Appendable/*TextBuilder*/ append(j2me.lang.CharSequence csq, int start,
                                                  int end) {
        if (csq == null)
            return append("null");
     ...
     *         (index > this.length())</code>
     */
    public final TextBuilder insert(int index, j2me.lang.CharSequence csq) {
        if ((index < 0) || (index > _length))
     ...
     */
    public final boolean contentEquals(j2me.lang.CharSequence csq) {
